...
def info(update: Update, context: CallbackContext):
    ...
    if user_id not in [bot.id, 5009839424, 2139897673]:
                    ...
                    [
                        [
                            InlineKeyboardButton(
                                "ᴜᴘᴅᴀᴛᴇs", url="https://t.me/The_Superiour_Network"),
                            InlineKeyboardButton(
                    ...
                    [
                        [
                            InlineKeyboardButton(
                                "ᴜᴘᴅᴀᴛᴇs", url="https://t.me/The_Superiour_Network"),
                            InlineKeyboardButton(
                                "sᴜᴘᴘᴏʀᴛ", url="https://t.me/World_FriendShip_Zone")
                        ],
                    ]
                ),
                parse_mode=ParseMode.HTML,
...
def set_about_me(update: Update, context: CallbackContext):
    ...
    if user_id in [5009839424, 2139897673]:
    ...
    if message.reply_to_message:
        ...
        if repl_user_id in [bot.id, 5009839424, 2139897673] and (user_id in DEV_USERS):
...
def stats(update: Update, context: CallbackContext):
    stats = "<b>✧ ᴄᴜʀʀᴇɴᴛ 🆉ᴇʙʀᴀ 🆁ᴏʙᴏᴛ</b>\n" + "\n".join([mod.__stats__() for mod in STATS])
    result = re.sub(r"(\d+)", r"<code>\1</code>", stats)
    result += "\n<b>✧ ʙᴏᴛ ᴏᴡɴᴇʀ sᴜᴍɪᴛ ʏᴀᴅᴀᴠ</b>"
    update.effective_message.reply_text(
        result,
        parse_mode=ParseMode.HTML, 
        disable_web_page_preview=True
...
def set_about_bio(update: Update, context: CallbackContext):
    ...
    if message.reply_to_message:
        ...
        if user_id in [5009839424, 2139897673] and sender_id not in DEV_USERS:
...
__command_list__ = ["setbio", "bio", "setzebra", "me", "info"]
__handlers__ = [
    ID_HANDLER,
    GIFID_HANDLER,
    INFO_HANDLER,
